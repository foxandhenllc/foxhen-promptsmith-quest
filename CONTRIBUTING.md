# Contributing to Promptsmith Quest

Promptsmith Quest is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A playable prompt-building puzzle for assembling constraints, quality gates, scoring, and exportable prompt handoffs.
